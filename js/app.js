...
const choiceContainer = Array.from(
  document.getElementsByClassName("choiceContainer")
);
...
// adding Optional chaining so it doesn't fail when on next page
document
  .getElementById("btnViewAnswers")
  ?.addEventListener("click", openAnswersBox);
document
  .getElementById("btnCloseAnswers")
  ?.addEventListener("click", closeAnswersBox);
